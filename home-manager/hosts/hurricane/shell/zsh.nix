    ...
    file = {
      ".zshrc" = {
        text = ''
          ...
          alias rebuild="nh os switch --nom --hostname=hurricane"
          alias genrm="sudo nix-env -p /nix/var/nix/profiles/system --delete-generations old ; nix-collect-garbage -d ; nh os switch --nom --hostname=hurricane"
          alias nix="neofetch"
        '';
      };
    };
