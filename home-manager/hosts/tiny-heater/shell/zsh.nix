    ...
    file = {
      ".zshrc" = {
        text = ''
          ...
          alias rebuild="nh os switch --hostname=tiny-heater"
          alias genrm="sudo nix-env -p /nix/var/nix/profiles/system --delete-generations old ; nix-collect-garbage -d ; nh os switch --hostname=tiny-heater"
