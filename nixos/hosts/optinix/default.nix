...
Changes to be committed:
  (use "git restore --staged <file>..." to unstage)
	modified:   flake.lock
	modified:   home-manager/programs/default.nix
	modified:   nixos/default.nix
	modified:   nixos/hosts/optinix/default.nix
	modified:   pkgs/fonts.nix


[nix-shell:~/.config/flake]$ cat nixos/hosts/optinix/default.nix ; git status
