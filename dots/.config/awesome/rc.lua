...
mytextclock = wibox.widget.textclock('<span color="#aaaaaa" font="JetBrains Mono Nerd Font 10"> %a %d.%b %R </span>', 5)
...
globalkeys = gears.table.join(
	...
	{description = "Restore all minimized windows", group = "client"}),
